...
DEFINE_BITFIELD(chemical_flags, list(
	...
	"REAGENT_NEUROWARE" = REAGENT_NEUROWARE, // NOVA EDIT ADDITION
))
...
DEFINE_BITFIELD(bodytype, list(
	...
	"BODYTYPE_SYNTHETIC" = BODYTYPE_SYNTHETIC,
...
DEFINE_BITFIELD(supports_variations_flags, list(
	...
	"CLOTHING_BIG_LEGS_VARIATION" = CLOTHING_BIG_LEGS_VARIATION,
	"CLOTHING_BIG_LEGS_MASK" = CLOTHING_BIG_LEGS_MASK,
	// NOVA EDIT ADDITION END
))
