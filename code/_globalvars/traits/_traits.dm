...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/obj/item/toy/plush/nova = list(
		...
		"TRAIT_DISPLAYING_AMMO_HUD" = TRAIT_DISPLAYING_AMMO_HUD,
		"TRAIT_DNR" = TRAIT_DNR,
		...
		"TRAIT_FOUR_ARMS" = TRAIT_FOUR_ARMS,
		...
		"TRAIT_HAIR_EXPERT" = TRAIT_HAIR_EXPERT,
		"TRAIT_HARD_SOLES" = TRAIT_HARD_SOLES,
		"TRAIT_HEAVYSET" = TRAIT_HEAVYSET,
		...
		"TRAIT_MASQUERADE_FOOD" = TRAIT_MASQUERADE_FOOD,
		...
		"TRAIT_LUNCHBOX_OWNER" = TRAIT_LUNCHBOX_OWNER,
		"TRAIT_PET_SPACE_TREAT" = TRAIT_PET_SPACE_TREAT,
		"TRAIT_PERMIT_HUD" = TRAIT_PERMIT_HUD,
		"TRAIT_PSIONIC_DAMPENER" = TRAIT_PSIONIC_DAMPENER,
		...
		"TRAIT_RESTING_ALTS" = TRAIT_RESTING_ALTS,
		...
		"TRAIT_SLIDING_UNDER" = TRAIT_SLIDING_UNDER,
		...
		"TRAIT_TAUR_LOAF" = TRAIT_TAUR_LOAF,
		"TRAIT_TRASHMAN" = TRAIT_TRASHMAN,
		"TRAIT_TWITCH_ADAPTED" = TRAIT_TWITCH_ADAPTED,
		"TRAIT_UNUSUAL_BIOCHEMISTRY" = TRAIT_UNUSUAL_BIOCHEMISTRY,
